...
<header><h1>Winners Who Have Not Paid (Admin View)</h1></header>
</html>
...
$SQL="SELECT Bidder.BidderID, Bidder.Name, Bidder.Address, Bidder.HomeNumber, Lot.LotID, Bidder.Paid FROM Bidder INNER JOIN Lot ON Bidder.BidderID=Lot.WinningBidder WHERE Bidder.Paid=0;";
...
if($sth->rowCount()==0){
	...
	echo "<br/><b>There are no Lots that have not been delivered at this time, Please check back later...</b><br/>";
...
echo"<tr>";
echo"<th colspan='10'>Lots Not Delivered</th>";
echo"</tr>";

	echo"<tr>";
		echo"<th>Biddder ID:</th>";
		echo"<th>Name:</th>";
		echo"<th>Address:</th>";
...
while($result= $sth->fetch()){
	...
	echo "<b>Bidder ID: </b>" . $result['BidderID'] . "<br/>";
	echo "<b>Name: </b>" . $result['Name'] . "<br/>";
	echo "<b>Address: </b>" . $result['Address'] . "<br/>";
	echo "<b>HomeNumber: </b>" . $result['HomeNumber'] . "<br/>";	
	echo "<b>Lot ID: </b>" . $result['LotID'] . "<br/>";
	
	
	echo "<b>Paid Status: </b>";
	if ($result['Paid']=="1"){ 
	...
	echo"<br/><font color='red'><b>You have won Lot: " . $result['LotID'] . "!</font></b><br/>";
	
	echo "<br/><a href='deletebidder.php?BidderID=" . $result['BidderID'] . "'>Delete Bidder #" . $result[BidderID] . "</a><br/>";
